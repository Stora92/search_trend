...
image = Image.open('Immagine 2021-12-13 171405.png')
st.image(image, caption='Esempio di file CSV da caricare')
st.subheader("Consiglio di non caricare più di 100 keyword al giorno ma ovviamente siete liberi di provarci comunque")
